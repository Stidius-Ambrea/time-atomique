// ============================================================================
//  Ambrea Atomic Clock - Synchronisation Check API V2
//  Compare l'heure locale Europe/Paris à 3 sources externes (HTTP Date)
//  et renvoie un rapport complet pour vérification croisée.
// ============================================================================
...
export const onRequestGet: PagesFunction = async () => {
  // @ts-ignore Temporal dispo sur Cloudflare Pages
  ...
  const avgDelta =
    deltas.length > 0
      ...
      : null;
  const overall =
    maxAbsDelta !== null && maxAbsDelta <= THRESHOLD_SECONDS ? "OK" : "⚠ WARN";
